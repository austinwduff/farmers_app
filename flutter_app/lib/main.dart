...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void loginPressed() {
    networkManager.register(email, password).then((value) => { if (value != null) handleRegisterLogin(value) });
  }

  void handleRegisterLogin(String value) {
    print(value);
    NetUtil.setString(NetUtil.KEY_USERID, value);
        ...
        child: Center(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              TextField(
                controller: emailTextController..text = NetUtil.activeUserId,
